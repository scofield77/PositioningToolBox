...
class DualFeetImuComplex:
    ...
    def __init__(self,
        ...
        self.G = np.zeros([self.state.shape[0], 12])
    ...
    def state_transaction_function(self, l_imu_data,
        ...
        # print(np.transpose(self.state[15:21]))
    ...
    def measurement_zv(self,
        ...
        #         (left_zv_flag > 0.5 or \
        #          right_zv_flag > 0.5):
        if np.linalg.norm(self.state[0:3] - self.state[15:18]) > max_distance :
            '''
