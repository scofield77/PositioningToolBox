...
class ImuEKFComplex:
            ...
            if (eta_k[0] > ka_squard):
                ...
                if len(self.uwb_eta_dict[beacon_id]) > serial_length:
                    ...
                    if lambda_k > T_d:
                        ...
                        # standard form in Guobin Chang's paper "Robust kalman filtering based on Mahalanobis distance as
                        # outlier judgice"
    ...
    def measurement_uwb_sp_itea(self, measurement, cov_m, beacon_set, ref_trace):
        '''
